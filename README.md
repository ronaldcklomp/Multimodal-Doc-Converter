...
2. **Processing:**
Place your PDFs in the `data/` directory and run the processor:
```bash
python src/mmrag_converter/v2/processor.py

```


3. **Output:**
Your structured data will be available in the `_v2_output` folder, ready for ingestion into Pinecone, Milvus, or Weaviate.
